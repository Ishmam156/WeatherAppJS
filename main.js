...
/***/ "./src/scripts/addWeatherToDOM.js":
/*!****************************************!*\
  !*** ./src/scripts/addWeatherToDOM.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "displayWeatherToDOM": () => (/* binding */ displayWeatherToDOM)
/* harmony export */ });
...
const displayWeatherToDOM = (data, tempDegree) => {
  ...
  document.getElementById("tempDescription").textContent = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.capitalize)(
...
/* harmony import */ var _images_wind_svg__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../images/wind.svg */ "./src/images/wind.svg");
...
/* harmony import */ var _images_humidity_svg__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../images/humidity.svg */ "./src/images/humidity.svg");
...
const addColorMode = () => {
  ...
  const images = [
    {
      image: _images_sun_svg__WEBPACK_IMPORTED_MODULE_0__,
      active: true,
    },
    {
      image: _images_moon_svg__WEBPACK_IMPORTED_MODULE_1__,
      active: false,
    },
  ];
  ...
  const weatherImages = [
    {
      id: "windValue",
      image: _images_wind_svg__WEBPACK_IMPORTED_MODULE_2__,
    },
    {
      id: "pressureValue",
      image: _images_pressure_svg__WEBPACK_IMPORTED_MODULE_3__,
    },
    {
      id: "humidityValue",
      image: _images_humidity_svg__WEBPACK_IMPORTED_MODULE_4__,
    },
  ];
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getWeatherDataOfLocation": () => (/* binding */ getWeatherDataOfLocation),
/* harmony export */   "getWeatherOfCoordinates": () => (/* binding */ getWeatherOfCoordinates)
/* harmony export */ });
...
const getWeatherOfCoordinates = async (lat, long) => {
  ...
  try {
    const response = await axios__WEBPACK_IMPORTED_MODULE_0___default().get(
      `https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${long}&APPID=${"a8c203d678306ca684102b8fd56344b4"}&units=metric`
    );
...
const getWeatherDataOfLocation = async (location, unit = "metric") => {
  ...
  try {
    const response = await axios__WEBPACK_IMPORTED_MODULE_0___default().get(
      `https://api.openweathermap.org/data/2.5/weather?q=${location}&APPID=${"a8c203d678306ca684102b8fd56344b4"}&units=${unit}`
    );
    weatherData = response.data;
  } catch (err) {
    console.error("Please provide a correct location!");
...
/***/ "./src/scripts/weatherSearchInput.js":
/*!*******************************************!*\
  !*** ./src/scripts/weatherSearchInput.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "addLocationSearchListener": () => (/* binding */ addLocationSearchListener),
/* harmony export */   "locationInput": () => (/* binding */ locationInput),
/* harmony export */   "geoLocationInput": () => (/* binding */ geoLocationInput)
/* harmony export */ });
/* harmony import */ var _getWeatherData__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getWeatherData */ "./src/scripts/getWeatherData.js");
/* harmony import */ var _helper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helper */ "./src/scripts/helper.js");
/* harmony import */ var _addWeatherToDOM__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./addWeatherToDOM */ "./src/scripts/addWeatherToDOM.js");
  ...
  if (element.nodeName === "SPAN") {
    ...
    searchForm.addEventListener("submit", async (event) => {
      ...
      if (!searchValue) {
        ...
        (0,_helper__WEBPACK_IMPORTED_MODULE_1__.showErrorMessage)("You need to enter a location!", newInput, 2000);
      ...
      const weatherData = await (0,_getWeatherData__WEBPACK_IMPORTED_MODULE_0__.getWeatherDataOfLocation)(searchValue);

      removeSpinningLoader();

      if (weatherData) {
        (0,_addWeatherToDOM__WEBPACK_IMPORTED_MODULE_2__.displayWeatherToDOM)(weatherData);
      } else {
        (0,_helper__WEBPACK_IMPORTED_MODULE_1__.showErrorMessage)(
      ...
      nameElement.textContent = (0,_helper__WEBPACK_IMPORTED_MODULE_1__.capitalize)(searchValue);
    });
  }
};
...
const degreeChange = async (element) => {
  ...
  const weatherData = await (0,_getWeatherData__WEBPACK_IMPORTED_MODULE_0__.getWeatherDataOfLocation)(
    locationToSearch,
    currentDegree === "C" ? "imperial" : "metric"
  );
  (0,_addWeatherToDOM__WEBPACK_IMPORTED_MODULE_2__.displayWeatherToDOM)(weatherData, currentDegree);
};
...
const geoLocationInput = async (lat, long) => {
  showSpinningLoader();
  const weatherData = await (0,_getWeatherData__WEBPACK_IMPORTED_MODULE_0__.getWeatherOfCoordinates)(lat, long);
  removeSpinningLoader();
  ...
  const nameElement = document.getElementById("weatherLocation");
  nameElement.innerHTML = "";
  nameElement.textContent = (0,_helper__WEBPACK_IMPORTED_MODULE_1__.capitalize)(weatherData.name);
};
...
"use strict";
module.exports = __webpack_require__.p + "c0169a4407a86c4084ee.svg";
...
"use strict";
module.exports = __webpack_require__.p + "ee1a77e0fe0d676e8ff7.svg";
...
"use strict";
module.exports = __webpack_require__.p + "4955aef4c57dac19404f.svg";
...
"use strict";
module.exports = __webpack_require__.p + "137e9c17591c362fd3de.svg";
...
"use strict";
module.exports = __webpack_require__.p + "6e7e26279a4099135c1c.svg";
...
/* harmony import */ var _scripts_weatherSearchInput__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./scripts/weatherSearchInput */ "./src/scripts/weatherSearchInput.js");
...
(0,_scripts_weatherSearchInput__WEBPACK_IMPORTED_MODULE_3__.addLocationSearchListener)();
// Initialize app with search bar at start
(0,_scripts_weatherSearchInput__WEBPACK_IMPORTED_MODULE_3__.locationInput)(document.getElementById("weatherLocation"));

// Check if user is willing to provide location and then set weather if provided
if (window.navigator.geolocation) {
  window.navigator.geolocation.getCurrentPosition((data) => {
    (0,_scripts_weatherSearchInput__WEBPACK_IMPORTED_MODULE_3__.geoLocationInput)(data.coords.latitude, data.coords.longitude);
  }, console.log);
}
